 ...
 * @since       1.2
 *
 * @see ajava.beans.beancontext.BeanContext
 * @see ajava.beans.PropertyChangeEvent
 * @see ajava.beans.PropertyChangeListener
 * @see ajava.beans.PropertyVetoException
 * @see ajava.beans.VetoableChangeListener
 */
...
public interface BeanContextChild {
     ...
     * shall fire a ajava.beans.PropertyChangeEvent, with parameters:
     *
