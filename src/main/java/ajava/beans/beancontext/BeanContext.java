 ...
 * @since 1.2
 *
 * @see ajava.beans.Beans
 * @see ajava.beans.beancontext.BeanContextChild
 * @see ajava.beans.beancontext.BeanContextMembershipListener
 * @see ajava.beans.PropertyChangeEvent
 * @see ajava.beans.DesignMode
 * @see ajava.beans.Visibility
...
public interface BeanContext extends BeanContextChild, Collection, DesignMode, Visibility {
     ...
     * <code>ajava.beans.Beans.instantiate()</code> method.
     *
